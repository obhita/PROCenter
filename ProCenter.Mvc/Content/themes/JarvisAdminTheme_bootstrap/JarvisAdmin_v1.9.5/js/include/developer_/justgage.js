...
JustGage = function(config) { 
  ...
  this.config = 
  {
    ...
    titleFontColor : (config.titleFontColor) ? config.titleFontColor : "#757272",
    ...
    valueFontColor : (config.valueFontColor) ? config.valueFontColor : "#DDD",
    ...
    gaugeColor : (config.gaugeColor) ? config.gaugeColor : "#515151",
