...
namespace GhostDocHelper_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(FEI.GhostDocHelper.GuidList.guidGhostDocHelperCmdSet, (int)FEI.GhostDocHelper.PkgCmdIDList.cmdidDocumentFile);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "GhostDocHelper", "FEI.GhostDocHelper.GhostDocHelperPackage");
