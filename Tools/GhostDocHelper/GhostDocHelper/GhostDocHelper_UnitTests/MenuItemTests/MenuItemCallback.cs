...
using FEI.GhostDocHelper;

namespace GhostDocHelper_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new GhostDocHelperPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(FEI.GhostDocHelper.GuidList.guidGhostDocHelperCmdSet, (int)FEI.GhostDocHelper.PkgCmdIDList.cmdidDocumentFile);
