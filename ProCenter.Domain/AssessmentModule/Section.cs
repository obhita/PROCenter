namespace ProCenter.Domain.AssessmentModule
{
    ...
    /// <summary>The section class.</summary>
    public class Section : AssessmentPart, IItemDefinitionProvider
    {
        ...
        public ItemDefinition CreateItemDefinition(CodedConcept codedConcept)
        {
            ...
            return new ItemDefinition(codedConcept, ItemType.Section, null, null, itemDefinitions);
        }
    }
}