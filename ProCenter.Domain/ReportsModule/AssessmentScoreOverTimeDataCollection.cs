namespace ProCenter.Domain.ReportsModule
{
    ...
    /// <summary>The assessment score over time data collection class.</summary>
    public class AssessmentScoreOverTimeDataCollection : ArrayList, ITypedList
    {
        ...
        public PropertyDescriptorCollection GetItemProperties ( PropertyDescriptor[] listAccessors )
        {
            if ( listAccessors != null && listAccessors.Length > 0 )
            {
                ...
                if ( listAccessor.PropertyType == typeof(List<ScoreData>) )
                {
                    return TypeDescriptor.GetProperties ( typeof(ScoreData) );
                }
            }
            return TypeDescriptor.GetProperties ( typeof(AssessmentScoreOverTimeData) );
        }
        ...
        {
            return "AssessmentScoreOverTimeData";
        }
