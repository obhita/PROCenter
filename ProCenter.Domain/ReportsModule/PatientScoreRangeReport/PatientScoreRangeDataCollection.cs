namespace ProCenter.Domain.ReportsModule.PatientScoreRangeReport
{
    ...
    /// <summary>
    /// The PatientScoreRangeDataCollection class.
    /// </summary>
    public class PatientScoreRangeDataCollection : ArrayList, ITypedList
    {
        ...
        public PropertyDescriptorCollection GetItemProperties ( PropertyDescriptor[] listAccessors )
        {
            ...
            return TypeDescriptor.GetProperties(typeof(PatientScoreRangeData));
        }
